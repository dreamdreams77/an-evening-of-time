...
Open `index.html` in any browser — no build step, no dependencies (except Google Fonts CDN for typography).

## GitHub Pages

1. Push to GitHub
2. Go to Settings → Pages → Source: main branch / root
3. Visit `https://YOUR-USERNAME.github.io/an-evening-of-time/`

If you see an old cached version: add `?v=2` to the URL, or open in a private/incognito window.
